...
;!p.multi = [1,2,1,1,1]
device, file = fig_path+'anton_network_results.ps',  /inches, bits = 32, /color, /landscape, xsize=10, ysize=5
...
plot, t_re, ab_re(0:nstep_re-1,n_sp(0)), /ylog, xrange = [1000, 1.2d6],yrange = [1d-14, 1d-3], linestyle = 0, charsize = 1, xtitle="t, years", ytitle="n(X)/n!DH!N", xstyle=1
...
plot, t_re, ab_re(0:nstep_re-1,n_sp(0)), /ylog, xrange = [1000,1.2d6], yrange = [1d-14, 1d-3], $
